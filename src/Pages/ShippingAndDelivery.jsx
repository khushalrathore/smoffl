...
const ShippingAndDelivery = () => {
  return (
    <div className={styles.deliveryContainer}>
      ...
      <p className={styles.paragraph}>Welcome to ShineMoon Pvt. Ltd., where learning video editing is convenient and accessible. Here’s everything you need to know about how we deliver our online courses:</p>
      ...
      <p className={styles.paragraph}>ShineMoon Pvt. Ltd.<br />Jaipur, Rajasthan 302012<br />India</p>
      ...
      <p className={styles.paragraph}>If you have any further questions about our shipping and delivery process, feel free to reach out to us at <a href="mailto:support@shinemoon.in" className={styles.link}>support@shinemoon.in</a>. We look forward to helping you achieve your video editing goals with ShineMoon Pvt. Ltd.</p>
    </div>
  );
};
